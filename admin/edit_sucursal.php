    ...
    <?php
        ...
        if (isset($_SESSION['sucursal_existente']) && $_SESSION['sucursal_existente'] == true) {
            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                Sucursal ya existente. Intente con otro por favor.
            ...
            <main class="col-12 col-lg-10 p-4">
                <div class="w-50 mx-auto">
                    ...
                    <form method="post" action="sucursal_connection.php" enctype="multipart/form-data">
                        ...
                        <input type="municipio" class="form-control" id="municipio" name="municipio" value="<?php echo $row['municipio'];?>" required>
                        ...
                        <input type="telefono" class="form-control" id="telefono" name="telefono" value="<?php echo $row['telefono'];?>" required>

        ...
        <div class="row">
            ...
            <main class="col-12 col-lg-10 p-4">
                <div class="w-50 mx-auto">
                    <h1 class="mb-3">Editar Trabajador</h1>
                    <form method="get" action="worker_connection.php">
                        ...
                        <label for="privilegio" class="form-label mt-3">Privilegio</label>
